...
export default function WeekHighlights() {
    ...
    return (
        <section className='py-12 px-4 bg-gray-50'>
            ...
            {/* Offer Cards Section */}
            <div className='flex flex-col md:flex-row gap-6 p-6 md:p-10 mt-10 mx-auto max-w-7xl rounded-lg justify-center'>
                {/* First Offer - Green Theme */}
                <div className='w-full md:flex-1 bg-green-100 rounded-xl p-6 md:p-8 h-auto md:h-48 flex items-center justify-between relative overflow-hidden'>
                    <div className='z-20 relative'>
                        <h3 className='text-green-800 font-bold text-2xl mb-2'>30% Discount</h3>
                        <h4 className='text-green-800 font-bold text-2xl mb-4'>Lipstick & Creme</h4>
                        <p className='text-green-700 text-base mb-2'>Lowest Price</p>
                ...
                {/* Second Offer - Beige/Orange Theme */}
                <div className='w-full md:flex-1 bg-orange-50 rounded-xl p-6 md:p-8 h-auto md:h-48 flex items-center justify-between relative overflow-hidden'>
                    <div className='z-20 relative'>
                        <h3 className='text-orange-800 font-bold text-2xl mb-2'>25% Discount</h3>
                        <h4 className='text-orange-800 font-bold text-2xl mb-4'>Compact Powder</h4>
                        <p className='text-orange-700 text-base mb-2'>Starting from</p>
                ...
                {/* Third Offer - Purple Theme */}
                <div className='w-full md:flex-1 bg-purple-100 rounded-xl p-6 md:p-8 h-auto md:h-48 flex items-center justify-between relative overflow-hidden'>
                    <div className='z-20 relative'>
                        <h3 className='text-purple-800 font-bold text-2xl mb-2'>Up to 50% Off</h3>
                        <h4 className='text-purple-800 font-bold text-2xl mb-4'>Cleansing Gel</h4>
                        <p className='text-purple-700 text-base mb-2'>Lowest Price</p>
            ...
            {/* Discount Banner */}
            <div>
                <p className='text-black font-bold text-2xl text-center'>Shop By Discounts!</p>
                <div className='flex justify-center items-center gap-[15px] mt-4'>
                    <div className='text-red-500 font-semibold text-[20px] mt-[-10px]'>🔥Hurry up ! Sale end in:​</div>
                    <div className='flex grid-rows-1 gap-2'>
                        <div className='text-red-500 font-bold w-16 h-16 border-2 rounded-2xl  p-2.5'>00 <span className='mt-2'>DAYS</span></div>
                        <div className='text-red-500 font-bold w-20 h-16 border-2 rounded-2xl  p-2.5'>00 <span className='mt-2'>HOURS</span></div>
                        <div className='text-red-500 font-bold w-16 h-16 border-2 rounded-2xl  p-2.5'>00 <span className='mt-2'>MINS</span></div>
                        <div className='text-red-500 font-bold w-16 h-16 border-2 rounded-2xl  p-2.5'>00 <span className='mt-2'>SECS</span></div>
                    </div>
                </div>
